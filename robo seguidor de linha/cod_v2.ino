...
int verde_min = 200, verde_max =250;
...
delay(50);
  ...
  else if ((valorDigitalDireita == BRANCO) && (valorDigitalCentral == PRETO) && ((valorAnalogicoEsquerda >= verde_min) && (valorAnalogicoEsquerda <= verde_max))) {
    Parar(300);
    CurvaEsquerda(); //QUASE 100% COLOCAR DELAY MAIOR PRA CURVA OU PODE SER A BATERIA
  }
  else if ((valorDigitalEsquerda == BRANCO) && (valorDigitalCentral == PRETO) && ((valorAnalogicoDireita >= verde_min) && (valorAnalogicoDireita <= verde_max))) {
    Parar(300);
    CurvaDireita();
  }
  else{
...
void leituraSensorInfra(){
  ...
  analogRead(valorAnalogicoEsquerda);
  analogRead(valorAnalogicoCentral);
  analogRead(valorAnalogicoDireita);
}
