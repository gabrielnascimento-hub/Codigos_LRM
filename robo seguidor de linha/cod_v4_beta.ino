...
delay(50);
  ...
  if ((valorDigitalCentral == PRETO) && (valorDigitalEsquerda == BRANCO) && (valorDigitalDireita == BRANCO)){
    ...
    Parar(700);
    leituraSensorInfra();
    if((valorAnalogicoEsquerda >= verde_min) && (valorAnalogicoEsquerda <= verde_max)){
      CurvaEsquerda();
    } 
  }
    ...
    Parar(700);
    leituraSensorInfra();
    if((valorAnalogicoDireita >= verde_min) && (valorAnalogicoDireita <= verde_max)){
      CurvaDireita();
    } 
  }
  /*else if((valorDigitalEsquerda == PRETO) && (valorDigitalCentral == PRETO) && (valorDigitalDireita == PRETO)){
    ...
    while(cont <= 10){
      leituraSensorInfra();
      if((valorDigitalEsquerda == PRETO) && (valorDigitalCentral == PRETO) && (valorDigitalDireita == PRETO)){
        leituraPreto++;
      }
      if((valorAnalogicoDireita >= verde_min) && (valorAnalogicoDireita <= verde_max)){
        leituraVerde++;
